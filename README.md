...
Dataset berisi kumpulan video beberapa orang yang mengucapkan kata tertentu.
Dalam penelitian ini digunakan 8 kata utama:
air, bakso, doa, kopi, novel, puding, rumus, surat

Dataset melibatkan lebih dari satu subjek sehingga mencakup variasi bentuk wajah, gaya bicara, dan gerakan bibir.

🧠 Model Architecture

3D CNN → Ekstraksi fitur spasial & temporal dari video

Bidirectional LSTM → Pemodelan urutan gerakan bibir
